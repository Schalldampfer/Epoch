if (hasInterface) then {
	...
	call compile preprocessFileLineNumbers "addons\A3EAI_Client\A3EAI_client_config.sqf";
	call compile preprocessFileLineNumbers "addons\A3EAI_Client\A3EAI_client_verifySettings.sqf";
	call compile preprocessFileLineNumbers "addons\A3EAI_Client\A3EAI_client_functions.sqf";
