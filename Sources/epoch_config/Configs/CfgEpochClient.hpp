...
class CfgEpochClient
{
	...
	RemoveTIfromUAV = "false";		// remove Thermal from assembled UAV's
	...
	UnconsciousTime[] = {30,60};	// Min / Max time for unconscious after you got a hit from a non lethal weapon / Axe / Sledge / Sword
    ...
    niteLight[] = {1,2.4,50}; // 0 = disabled or 1 = enabled, Set ambient lighting at night: {Brightness of light,Height of light}. Default (Low Ambient): {1.88,22} | Twilight: {7.2,88} | Distant: {12.8,142}
