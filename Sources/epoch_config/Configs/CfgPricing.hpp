...
class CfgPricing
{
	...
	class CUP_O_Hilux_armored_DSHKM_TK_INS {price = 22000;tax = 0.4;};
	class CUP_O_Hilux_armored_M2_TK_INS {price = 22000;tax = 0.4;};
	class CUP_O_Hilux_DSHKM_TK_INS {price = 20000;tax = 0.4;};
	class CUP_O_Hilux_M2_TK_INS {price = 20000;tax = 0.4;};
	class CUP_O_Hilux_btr60_TK_INS {price = 35000;tax = 0.4;};
	class CUP_B_HMMWV_M1114_USMC {price = 22000;tax = 0.9;};
	class CUP_B_HMMWV_M2_USMC {price = 25000;tax = 0.9;};
	class CUP_B_M1165_GMV_USMC {price = 35000;tax = 0.9;};
	...
	class CUP_O_UAZ_MG_CSAT {price = 20000;tax = 0.9;};
	class CUP_O_UAZ_AGS30_RU {price = 22000;tax = 0.9;};
	class CUP_O_UAZ_AGS30_CSAT {price = 22000;tax = 0.9;};
	...
	class CUP_hgun_PMM {price = 25;};
	class CUP_hgun_Deagle {price = 75;};
	class CUP_hgun_Mk23 {price = 75;};
	class CUP_hgun_Mac10 {price = 45;};
	class CUP_hgun_MP7 {price = 150;};
	class CUP_hgun_TEC9 {price = 45;};
	class CUP_srifle_Mosin_Nagant {price = 100;};
	class CUP_srifle_Remington700 {price = 200;};
	class CUP_sgun_CZ584 {price = 20;};
	class CUP_sgun_SPAS12 {price = 50;};
	class CUP_sgun_M1014_Entry_vfg {price = 50;};
	class CUP_smg_vityaz {price = 100;};
	class CUP_smg_saiga9 {price = 45;};
	class CUP_smg_MP5A5_flashlight {price = 105;};
	class CUP_smg_PS90_olive {price = 50;};
	class CUP_arifle_SAIGA_MK03_top_rail {price = 45;};
	class CUP_arifle_SIAGE_MK03_Wood_top_rail {price = 45;};
	class CUP_SKS {price = 100;};
	...
	class CUP_arifle_AK74M_railed {price = 80;};
	class CUP_arifle_G36A_RIS {price = 80;};
	class CUP_arifle_G36K_RIS {price = 80;};
	class CUP_arifle_AUG_A1 {price = 75;};
	class CUP_arifle_HK416_CQB_Black {price = 75;};
	class CUP_arifle_HK416_Black {price = 75;};
	class CUP_arifle_HK_M27 {price = 80;};
	class CUP_arifle_L85A2_NG {price = 75;};
	class CUP_arifle_M16A1 {price = 75;};
	class CUP_arifle_M16A4_Grip {price = 75;};
	class CUP_arifle_M4A3_black {price = 75;};
	class CUP_arifle_mk18_black {price = 75;};
	class CUP_arifle_SBR_black {price = 75;};
	...
	class CUP_arifle_Fort224 {price = 75;};
	class CUP_arifle_Fort221 {price = 75;};
	class CUP_arifle_FNFAL5060_railed {price = 80;};
	...
	class CUP_arifle_AG36 {price = 80;};
	class CUP_arifle_HK416_M203_Black {price = 80;};
	class CUP_arifle_HK417_20 {price = 80;};
	class CUP_srifle_L129A1 {price = 200;};
	class CUP_srifle_DMR {price = 200;};
	class CUP_srifle_M24_blk {price = 200;};
	class CUP_srifle_SVD_top_rail {price = 200;};
	class CUP_srifle_RSASS_Black {price = 200;};
	class CUP_srifle_m110_kac {price = 200;};
	class CUP_lmg_FNMAG {price = 150;};
	class CUP_lmg_M249 {price = 150;};
	class CUP_lmg_M60 {price = 150;};
	class CUP_lmg_MG3_rail {price = 150;};
	class CUP_lmg_Mk48 {price = 150;};
	class CUP_lmg_PKMN {price = 150;};

    class CUP_1Rnd_StarCluster_White_M203 { price = 15; };
    class CUP_1Rnd_StarCluster_Red_M203 { price = 15; };
    class CUP_1Rnd_StarCluster_Green_M203 { price = 15; };
    class CUP_1Rnd_StarFlare_White_M203 { price = 10; };
    class CUP_1Rnd_StarFlare_Red_M203 { price = 10; };
    class CUP_1Rnd_StarFlare_Green_M203 { price = 10; };
    class CUP_IlumFlareWhite_GP25_M { price = 10; };
    class CUP_IlumFlareRed_GP25_M { price = 10; };
    class CUP_IlumFlareGreen_GP25_M { price = 10; };
    class CUP_1Rnd_HE_GP25_M { price = 10; };
    class CUP_1Rnd_HE_M203 { price = 10; };
    class CUP_1Rnd_HEDP_M203 { price = 15; };
    class CUP_FlareWhite_M203 { price = 5; };
    class CUP_FlareGreen_M203 { price = 5; };
    class CUP_FlareRed_M203 { price = 5; };
    class CUP_FlareYellow_M203 { price = 5; };
    class CUP_FlareWhite_GP25_M { price = 5; };
    class CUP_FlareGreen_GP25_M { price = 5; };
    class CUP_FlareRed_GP25_M { price = 5; };
    class CUP_FlareYellow_GP25_M { price = 5; };
    class CUP_1Rnd_Smoke_M203 { price = 5; };
    class CUP_1Rnd_SmokeRed_M203 { price = 5; };
    class CUP_1Rnd_SmokeGreen_M203 { price = 5; };
    class CUP_1Rnd_SmokeYellow_M203 { price = 5; };
    class CUP_1Rnd_SMOKE_GP25_M { price = 5; };
	...
	class CUP_25Rnd_762x51_Galil_Mag {price = 5;tax = 0.9;};
	class CUP_120Rnd_TE4_LRT4_White_Tracer_762x51_Belt_M {price = 8;tax = 0.9;};
	class CUP_6Rnd_762x51_R700 {price = 6;tax = 0.9;};
	class CUP_5Rnd_762x54_Mosin_M {price = 5;tax = 0.9;};
	class CUP_20Rnd_9x39_SP5_GROZA_M {price = 5;tax = 0.9;};
	class CUP_200Rnd_TE4_Red_Tracer_556x45_M249 {price = 5;tax = 0.9;};
	class CUP_100Rnd_556x45_BetaCMag {price = 5;tax = 0.9;};
	class CUP_35Rnd_556x45_Galil_Mag {price = 4;tax = 0.9;};
	class CUP_30Rnd_556x45_Stanag {price = 3;tax = 0.9;};
	class CUP_30Rnd_556x45_AUG {price = 4;tax = 0.9;};
	class CUP_30Rnd_556x45_X95 {price = 4;tax = 0.9;};
	class CUP_30Rnd_556x45_AK {price = 3;tax = 0.9;};
	class CUP_30Rnd_556x45_CZ805 {price = 4;tax = 0.9;};
	class CUP_30Rnd_556x45_G36 {price = 4;tax = 0.9;};
	class CUP_30Rnd_556x45_Stanag_Mk16 {price = 4;tax = 0.9;};
	class CUP_30Rnd_556x45_XM8 {price = 4;tax = 0.9;};
	class CUP_25Rnd_556x45_Famas {price = 3;tax = 0.9;};
	class CUP_30Rnd_545x39_AK74_plum_M {price = 4;tax = 0.9;};
	class CUP_30Rnd_545x39_Fort224_M {price = 5;tax = 0.9;};
	class CUP_30Rnd_762x39_AK47_bakelite_M {price = 4;tax = 0.9;};
	class CUP_30Rnd_762x39_CZ807 {price = 5;tax = 0.9;};
	class CUP_10Rnd_762x39_SaigaMk03_M {price = 5;tax = 0.9;};
	...
	class CUP_acc_MLPLS_Laser {price = 5;tax = 0.9;};
	class CUP_muzzle_snds_KZRZP_SVD { price = 7; };
	class CUP_muzzle_snds_KZRZP_PK { price = 7; };
	class CUP_muzzle_snds_Mk12 { price = 5; };
	class CUP_muzzle_snds_68SPC { price = 7; };
	class CUP_muzzle_snds_KZRZP_AK762 { price = 7; };
	class CUP_muzzle_snds_KZRZP_AK545 { price = 5; };
	class CUP_muzzle_snds_mk23 { price = 5; };
	class CUP_muzzle_snds_MP7 { price = 5; };
	class CUP_muzzle_snds_SA61 { price = 5; };
	class CUP_muzzle_mfsup_Flashhider_545x39_Black { price = 5; };
	class CUP_muzzle_mfsup_Flashhider_762x39_Black { price = 5; };
	class CUP_muzzle_mfsup_Flashhider_PK_Black { price = 5; };
	class CUP_muzzle_mfsup_Flashhider_556x45_Black { price = 5; };
	class CUP_muzzle_mfsup_Flashhider_762x51_Black { price = 5; };

	class CUP_optic_AN_PVS_10_black { price = 10000; };
	class CUP_optic_LeupoldMk4_20x40_LRT { price = 1000; };
	class CUP_optic_LeupoldMk4_25x50_LRT { price = 1000; };
	class CUP_optic_PSO_1_AK { price = 1000; };
