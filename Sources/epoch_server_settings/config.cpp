...
//		worldSize = 12000;
		...
		radioactiveLocBLObjects[] = {"Transport_EPOCH"};		// PlotPoles are already blacklisted by script
...
//		TraderMinDistance = 1500;		// Min distance between Traders. If not defined, Server will calculate it by MapSize
		...
		allowedVehiclesList[] = {
		    ...
		    {"hoverboard_epoch_cargo",5},
		    {"hoverboard_epoch_bttf",5},
		    {"hoverboard_epoch_a3",5},
		    //{"K01",2},
		    //{"K02",2},
		    //{"K03",2},
		    //{"K04",2},
		...
		allowedVehiclesList_CUP[] = {
			{"CUP_O_PBX_RU",2},
			{"CUP_B_M1151_NATO_T",1},
			{"CUP_B_M1152_NATO_T",1},
			{"CUP_B_FENNEK_GER_Wdl",1},
			{"CUP_O_MTLB_pk_WDL_RU",1},
			{"CUP_B_M1030_USA",2},
			{"CUP_C_TT650_CIV",2},
			{"CUP_C_TT650_TK_CIV",2},
			{"CUP_B_Kamaz_Open_CDF",1},
			{"CUP_B_Kamaz_CDF",1},
			{"CUP_B_MTVR_USMC",1},
			{"CUP_O_Ural_Empty_SLA",1},
			{"CUP_C_V3S_Open_TKC",2},
			{"CUP_C_V3S_Covered_TKC",2},
			{"CUP_C_Ikarus_Chernarus",2},
			{"CUP_C_Ikarus_TKC",2},
			{"CUP_O_Hilux_armored_unarmed_TK_INS",1},
			{"CUP_O_Hilux_unarmed_TK_INS",2},
			{"CUP_C_Lada_White_CIV",2},
			{"CUP_C_Lada_Red_CIV",2},
			{"CUP_C_Lada_GreenTK_CIV",2},
			//{"CUP_LADA_LM_CIV",1},
			{"CUP_C_Volha_Blue_TKCIV",2},
			{"CUP_C_Volha_Gray_TKCIV",2},
			{"CUP_C_Volha_Limo_TKCIV",1},
			{"CUP_C_Tractor_CIV",2},
			{"CUP_C_Tractor_Old_CIV",2},
			{"CUP_C_MI6A_RU",2},
			{"CUP_C_Mi17_VIV_RU",2},
			{"CUP_C_Mi17_Civilian_RU",2},
			{"CUP_C_SA330_Puma_HC1_ChernAvia",2},
			{"CUP_B_MH6J_USA",1},
			{"CUP_B_MH6M_USA",1},
			{"CUP_B_UH60M_Unarmed_US",1},
			{"CUP_C_AN2_CIV",2},
			{"CUP_B_MV22_USMC_RAMPGUN",1},
			{"CUP_B_AC47_Spooky_USA",1},
