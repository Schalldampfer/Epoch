...
class Tanoa : Default
{
	...
	propsPos[] = {
		...
		// Pillbox
        { "ProtectionZone_Invisible_F", {9021.11,13268.5,0}, {{-0.756358,-0.644931,0.109482},{0.0239912,0.139902,0.989875}}, true },
        { "Transport_EPOCH", {9025.69,13271.4,0}, {{-0.000149416,0.999201,-0.0399764},{0,0,1}}, true },
        { "FirePlaceOn_EPOCH", {9019.29,13274.3,0}, {{0,0.999201,-0.03997},{-0.0159977,0.0399649,0.999073}}, false, true },
        { "SolarChargerXL_EPOCH", {9026.96,13267.1,0}, {{0.489475,0.871524,-0.0293189},{0.0266548,0.018653,0.999471}}, true },
        { "Land_Atm_02_F", {9031.1,13272.5,0}, {{0.83168,0.555255,0},{0,0,1}}, true },
		// Shrine
	...
	staticNpcPos[] = {
		...
		// Pillbox
        { "C_man_shorts_1_F_asia", { 9034.08, 13269.2, 0 }, 0.000 },
		{ "C_man_shorts_4_F_asia", { 9013.55,13276.9, 0 }, 19.664 }
	};
