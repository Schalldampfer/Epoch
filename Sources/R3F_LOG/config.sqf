 ...
 */
R3F_LOG_CFG_string_condition_allow_creation_factory_on_this_client = "serverCommandAvailable '#kick'";
...
[
    "AllVehicles","ReammoBox_F","ContainerSupply"
];
...
[
    "StaticWeapon","Motorcycle","FlagCarrierCore","ReammoBox_F","ContainerSupply"
];