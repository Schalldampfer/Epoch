...
// Default Loadout
	...
	defaultGoggles =			"";
	defaultHeadgear =			"H_Bandanna_surfer_grn";
	defaultBackpack =			"";
	defaultprimaryWeapon[] =	{"Rollins_F","","","optic_Aco",{"5Rnd_rollins_mag",5},{},""};		// {"arifle_MX_pointer_F","","acc_pointer_IR","",{"30Rnd_65x39_caseless_mag",29},{},""};
...
// Traders
	...
	storedVehicleLimit = 12;			// Vehicles more than x stored in ALL Traders will automatically be deleted on Restart. 
